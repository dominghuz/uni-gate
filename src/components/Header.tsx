...
export default function Header() {
  ...
  // Detecta preferência do sistema + localStorage
  useEffect(() => {
  ...
  // Atualiza o tema + salva no localStorage
  useEffect(() => {
        ...
        <div className="container mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center space-x-2 md:space-x-4">
              ...
              >
                {darkMode ? <Sun size={18} className="text-yellow-300" /> : <Moon size={18} className="text-neutral-700" />}
              </button>
